      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-2 lg:text-left mt-20 gap-8">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Take the quiz to find out where you fit in Spanish society.
          </p>
        </Link>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Find the region in Spain that matches your values and lifestyle.
          </p>
        </Link>
      </div>
    </main>
